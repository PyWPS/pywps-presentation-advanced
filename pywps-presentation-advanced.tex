...
\begin{itemize}
  ...
  \item a server with pre-installed processes \pause
\end{itemize}
...
\begin{itemize}
  ...
  \begin{itemize} 
    ...
    \item full control over SQL construction  \pause
  \end{itemize}
  ...
  \end{itemize}
  \item A single gateway for multiple database management systems  \pause
\end{itemize}
